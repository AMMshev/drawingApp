...
class ShopTableViewCell: UITableViewCell {
    ...
    fileprivate let paintImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage(named: Constants.ImageNames.fill.rawValue))
        imageView.translatesAutoresizingMaskIntoConstraints = false
        return imageView
    }()
    fileprivate var countAndBonusStackView: UIStackView = {
    ...
    fileprivate var bonusLabel = UILabel()
    fileprivate var taskLabel = UILabel()
    ...
    fileprivate var stickerView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        self.colorCountLabel.text = String(Int(colorCount))
    }
    ...
    @objc fileprivate func priceButtonTapped() {
